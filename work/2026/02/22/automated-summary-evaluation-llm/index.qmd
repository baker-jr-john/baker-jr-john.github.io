...
The working prototype runs [Meta's Llama 3.1 8B Instruct](https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct) with a [Gradio web interface](https://www.gradio.app/) that students can use directly. The app is live on [Hugging Face Spaces](https://huggingface.co/spaces/jbaker1/auto-rubric-evaluator).
...
I validated the system against 37 authentic student summaries drawn from the [ASAP 2.0 dataset](https://www.kaggle.com/datasets/lburleigh/asap-2-0), along with 23 synthetically generated summaries created using a separate [OpenAI GPT-4o mini](https://openai.com/index/gpt-4o-mini-advancing-cost-efficient-intelligence/) instance with controlled prompting.
