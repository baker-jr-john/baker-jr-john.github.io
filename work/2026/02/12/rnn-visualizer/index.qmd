...
I started with [Claude](https://claude.com/product/overview), but the initial results didn't match what I had in mind, so I switched to [Google Gemini](https://gemini.google.com/share/c04dea7081aa), where I iterated through multiple versions to build the core functionality. The back-and-forth was productive: I'd describe what I wanted ("a spreadsheet-like interface where you can click cells to edit values"), Gemini would implement it, and I'd test and refine.
...
If you're learning about RNNs, [try it out](https://johnbaker.io/rnn-visualizer){target="_blank"}, click around. Break things. Change the weights to ridiculous values and see what happens. Tell me about it. That's how understanding happens.