...
::: {.callout-note title="Click here to view the code I wrote with detailed explanations." collapse="true"}
```{python}
...
::: {.callout-note title="Click here to learn about the design principles and rationale behind my code." collapse="true"}
